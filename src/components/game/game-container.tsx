  ...
  return (
    <div className="flex flex-col items-center justify-center w-full">
      <div className="text-center mb-1 relative">
        <div className="absolute -top-4 -right-8 text-accent animate-pulse">
      ...
      <div className="grid grid-cols-3 gap-2 w-[280px] h-[280px] sm:w-[320px] sm:h-[320px] bg-white/40 backdrop-blur-md p-2 rounded-[1.5rem] pookie-shadow border-2 border-white relative overflow-hidden">
      ...
      <div className="mt-3">
        <Button
          ...
          variant="default"
          size="sm"
          className="rounded-full px-4 py-1 text-[10px] font-black uppercase tracking-tight shadow-sm hover:shadow-md transition-all duration-300 hover:scale-105 active:scale-95 bg-primary text-primary-foreground border-b-2 border-primary/40 h-9"
        >
